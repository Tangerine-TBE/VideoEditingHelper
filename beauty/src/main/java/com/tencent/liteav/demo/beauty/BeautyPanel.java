...
public class BeautyPanel extends FrameLayout implements SeekBar.OnSeekBarChangeListener, View.OnClickListener {
    ...
    public static final int BEAUTYPARAM_BEAUTY_STYLE_PITU = 2; // P图（优图优化后算法）
    public static final int BEAUTYPARAM_BEAUTY_STYLE_HAZY = 3; // 朦胧(原天天P图)
    ...
    private void initBeautyData() {
        ...
        int beauty_hazy = UIAttributeUtil.getResResources(getContext(), R.attr.beautyPanelPituIcon, R.drawable.ic_beauty_pitu);
        ...
        int beauty_facenarrow = UIAttributeUtil.getResResources(getContext(), R.attr.beautyPanelFacenarrowIcon, R.drawable.ic_beauty_facenarrow);
        ...
        mBeautyDataList.add(new BeautyData(beauty_facenarrow, getResources().getString(R.string.beauty_pannel_facenarrow)));
    ...
    private void initFilterData() {
        ...
        mFilterBeautyDataList.add(new BeautyData(R.drawable.ziran, getResources().getString(R.string.beauty_setting_pannel_filter_natural)));
        mFilterBeautyDataList.add(new BeautyData(R.drawable.baixi, getResources().getString(R.string.beauty_setting_pannel_filter_fair)));
...
//                                    ((TextView) v).setTextColor(mContext.getResources().getColor(R.color.colorRed));
    ...
    public Bitmap getFilterBitmapByIndex(int index) {
        ...
        switch (index) {
            case 1:
                ...
                break;
            case 2:
                bmp = decodeResource(getResources(), R.drawable.filter_natrual);
                break;
            case 3:
                bmp = decodeResource(getResources(), R.drawable.filter_fair);
                break;
            case 4:
        ...
        if (seekBar.getId() == R.id.seekbarThird) {
            if (mSencodGradleType == ITEM_TYPE_BEAUTY) {
                ...
                if (beautyType.equals(getResources().getString(R.string.beauty_pannel_style_smooth))) {
                    ...
                    mBeautyParams.mBeautyStyle = BEAUTYPARAM_BEAUTY_STYLE_PITU;
                    mBeautyParams.mBeautyLevel = progress;
                    if (mProxy != null) {
                        mProxy.setBeautyStyle(BEAUTYPARAM_BEAUTY_STYLE_PITU);
                        mProxy.setBeautyLevel(progress);
                    }
                ...
                } else if (beautyType.equals(getResources().getString(R.string.beauty_pannel_facenarrow))) {
                    mBeautyParams.mFaceNarrowLevel = progress;
                    if (mProxy != null) {
                        mProxy.setFaceNarrowLevel(progress);
                    }
    ...
    private void initSeekBarValue() {
        if (null == mSzSeekBarValue) {
            ...
            mSzSeekBarValue[ITEM_TYPE_BEAUTY][3] = mBeautyBasicLevel;
            mSzSeekBarValue[ITEM_TYPE_BEAUTY][4] = mWhiteBasicLevel;
            mSzSeekBarValue[ITEM_TYPE_BEAUTY][5] = mRuddyBasicLevel;
        }
    }

...
public class IntentUtils {
    ...
    public static void shareFile(Context context, File file, String shareType, String title) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            if (TYPE_VIDEO.equals(shareType)) {
                ...
                fileUri = FileProvider.getUriForFile(context, BaseApplication.mPackName+ ".fileProvider", file);
            }
    ...
    private static Uri getVideoContentUri(Context context, File file) {
        ...
        if (uri == null) {
            uri = FileProvider.getUriForFile(context, BaseApplication.mPackName + ".fileProvider", file);
        }
        return uri;
    }

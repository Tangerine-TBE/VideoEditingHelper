 ...
 * @class describe
 */
class PopupDeleteItemAdapter:BaseQuickAdapter<MediaInformation,BaseDataBindingHolder<ItemSelectPopupContainerBinding>>(R.layout.item_select_popup_container) {

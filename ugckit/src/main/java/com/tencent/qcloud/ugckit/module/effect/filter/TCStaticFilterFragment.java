...
public class TCStaticFilterFragment extends Fragment implements BaseRecyclerAdapter.OnItemClickListener {
    private static final int[] FILTER_ARR = {
            R.drawable.filter_biaozhun,R.drawable.filter_natrual,
            R.drawable.filter_fair,R.drawable.filter_yinghong,
    ...
    private int ziranIcon = R.drawable.ziran;
    private int baixiIcon = R.drawable.baixi;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ziranIcon = UIAttributeUtil.getResResources(getContext(), R.attr.editerFilterNaturalIcon, R.drawable.ziran);
        baixiIcon = UIAttributeUtil.getResResources(getContext(), R.attr.editerFilterFairIcon, R.drawable.baixi);
        ...
        mFilterList.add(ziranIcon);
        mFilterList.add(baixiIcon);
        ...
        mFilerNameList.add(getResources().getString(R.string.tc_static_filter_fragment_natural));
        mFilerNameList.add(getResources().getString(R.string.tc_static_filter_fragment_fair));
